...
var canvas = {
	vars: {
		...
		terrainTexture: {
		"beach": [['#dbd5ab', '#ddd8b1', '#ddd8b1', '#006fdd', '#006cd4', '#d9d3a7', '#d7d1a2', '#d6cfa0'],
		['#dcd6ad', '#d9d3a6', '#dad4a9', '#dad4aa', '#d8d2a4', '#d8d2a4', '#d8d2a4', '#dbd5ab'],
		['#d7d1a2', '#d8d2a4', '#dbd5ab', '#dcd6ad', '#dbd5ab', '#0067ca', '#006cd7', '#dbd5ab'],
		['#dad4aa', '#dfdab4', '#dbd5ab', '#dcd6ad', '#ddd8b0', '#0069d1', '#006cd7', '#d9d3a6'],
		['#ddd8b1', '#006fda', '#006ad3', '#006cd4', '#d9d3a6', '#dbd5ab', '#ddd8b0', '#dad4aa'],
		['#dfdab4', '#006ddc', '#ddd8b0', '#dbd5ab', '#dbd5ab', '#dad4aa', '#dad4aa', '#dcd6ad'],
		['#dcd6ad', '#dcd6ad', '#dbd5ab', '#d9d3a6', '#d8d2a4', '#0062c3', '#0069d1', '#0072e3'],
		['#d8d2a4', '#d8d2a4', '#d8d2a4', '#dad4aa', '#dbd5ab', '#006fdd', '#0070df', '#006cd7']],
		...
		"desert": [['#dbd5ab', '#ddd8b1', '#ddd8b1', '#ddd8b0', '#dad4aa', '#d9d3a7', '#d7d1a2', '#336600'],
		['#dcd6ad', '#d9d3a6', '#dad4a9', '#dad4aa', '#d8d2a4', '#d8d2a4', '#d8d2a4', '#336600'],
		['#d7d1a2', '#d8d2a4', '#336600', '#dcd6ad', '#dbd5ab', '#d7d1a2', '#dbd5ab', '#dbd5ab'],
		['#dad4aa', '#dfdab4', '#336600', '#dcd6ad', '#ddd8b0', '#d9d3a6', '#dbd5ab', '#d9d3a6'],
		['#ddd8b1', '#dcd6ad', '#d9d3a7', '#dad4aa', '#d9d3a6', '#dbd5ab', '#336600', '#dad4aa'],
		['#dfdab4', '#dcd6ad', '#ddd8b0', '#dbd5ab', '#dbd5ab', '#dad4aa', '#336600', '#dcd6ad'],
		['#dcd6ad', '#dcd6ad', '#dbd5ab', '#336600', '#d8d2a4', '#d5ce9d', '#d9d3a6', '#dfdab4'],
		['#d8d2a4', '#d8d2a4', '#d8d2a4', '#336600', '#dbd5ab', '#ddd8b0', '#ddd8b1', '#dbd5ab']],
		"desertHills": [['#dbd5ab', '#ddd8b1', '#ddd8b1', '#9d9d9d', '#989898', '#d9d3a7', '#d7d1a2', '#336600'],
		['#dcd6ad', '#d9d3a6', '#dad4a9', '#dad4aa', '#d8d2a4', '#d8d2a4', '#d8d2a4', '#336600'],
		['#d7d1a2', '#d8d2a4', '#336600', '#dcd6ad', '#dbd5ab', '#909090', '#999999', '#dbd5ab'],
		['#dad4aa', '#dfdab4', '#336600', '#dcd6ad', '#ddd8b0', '#949494', '#999999', '#d9d3a6'],
		['#ddd8b1', '#9b9b9b', '#969696', '#989898', '#d9d3a6', '#dbd5ab', '#336600', '#dad4aa'],
		['#dfdab4', '#9c9c9c', '#ddd8b0', '#dbd5ab', '#dbd5ab', '#dad4aa', '#336600', '#dcd6ad'],
		['#dcd6ad', '#dcd6ad', '#dbd5ab', '#336600', '#d8d2a4', '#8c8c8c', '#949494', '#a1a1a1'],
		['#d8d2a4', '#d8d2a4', '#d8d2a4', '#336600', '#dbd5ab', '#9d9d9d', '#9f9f9f', '#999999']],
		"desertM": [['#dbd5ab', '#ddd8b1', '#ddd8b1', '#bd8249', '#b97d43', '#d9d3a7', '#d7d1a2', '#336600'],
		['#dcd6ad', '#d9d3a6', '#dad4a9', '#dad4aa', '#d8d2a4', '#d8d2a4', '#d8d2a4', '#336600'],
		['#d7d1a2', '#d8d2a4', '#336600', '#dcd6ad', '#dbd5ab', '#b07740', '#bb7f44', '#dbd5ab'],
		['#dad4aa', '#dfdab4', '#336600', '#dcd6ad', '#ddd8b0', '#b57b42', '#bb7f44', '#d9d3a6'],
		['#ddd8b1', '#bc8046', '#b87d43', '#b97d43', '#d9d3a6', '#dbd5ab', '#336600', '#dad4aa'],
		['#dfdab4', '#bd8248', '#ddd8b0', '#dbd5ab', '#dbd5ab', '#dad4aa', '#336600', '#dcd6ad'],
		['#dcd6ad', '#dcd6ad', '#dbd5ab', '#336600', '#d8d2a4', '#aa733e', '#b57b42', '#bf864e'],
		['#d8d2a4', '#d8d2a4', '#d8d2a4', '#336600', '#dbd5ab', '#bd8249', '#be844b', '#bb7f44']],
