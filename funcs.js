...
"canyon": [['#50582f', '#ae9d6b', '#8d8176', '#8d8176', '#b09870', '#b09270', '#50582f', '#50582f'],
['#ad966e', '#8d8176', '#ae966c', '#50582f', '#b0936e', '#b1936c', '#aa996c', '#50582f'],
['#b5956d', '#b29c70', '#b39a70', '#50582f', '#ae9869', '#ac966c', '#af9a6e', '#423427'],
['#af9569', '#ae9b6d', '#50582f', '#50582f', '#50582f', '#8d8176', '#b2966a', '#423427'],
['#af966d', '#8d8176', '#8d8176', '#50582f', '#8d8176', '#b0946d', '#b1986b', '#b29a69'],
['#8d8176', '#b1996c', '#af996a', '#423427', '#ad986e', '#b29769', '#b2986e', '#8d8176'],
['#ac996e', '#ac9a72', '#b59c6a', '#423427', '#b09a70', '#ab9568', '#8d8176', '#50582f'],
['#ad976c', '#af966a', '#b1956a', '#af9a6e', '#8d8176', '#8d8176', '#b39b64', '#50582f']],
...
"dunes": [['#d5d39c', '#d6d59d', '#d4ce9d', '#dad0a0', '#d8d0a2', '#d8caa2', '#d5ca9f', '#d9d39a'],
['#bf5744', '#d7cca2', '#d6ce9e', '#d9d39a', '#d8cba0', '#d9cb9e', '#bf5744', '#dbcc9a'],
['#ddcd9f', '#dad4a2', '#dbd2a2', '#dad09e', '#6b4316', '#d4ce9e', '#d7d2a0', '#1c8811'],
['#d7cd9b', '#d6d39f', '#dad3a1', '#d5d099', '#d7d09f', '#d7d5a2', '#dace9c', '#dad39f'],
['#d7ce9f', '#bf5744', '#d4d3a2', '#bf5744', '#d7d0a4', '#d8cc9f', '#d9d09d', '#dad29b'],
['#d9d199', '#d9d19e', '#1c8811', '#d6d19c', '#d5d0a0', '#dacf9b', '#dad0a0', '#d8cba1'],
['#d4d1a0', '#d4d2a4', '#ddd49c', '#ddd19f', '#d8d2a2', '#d3cd9a', '#d5d19f', '#d3cd9d'],
['#d5cf9e', '#d7ce9c', '#d9cd9c', '#d7d2a0', '#d8cc9e', '#dbcf9e', '#6b4316', '#dccea1']],
...
"flower-field": [['#386921', '#396b22', '#376422', '#3d6625', '#3b6627', '#3b6027', '#386024', '#3c691f'],
['#c53312', '#3a6227', '#396423', '#3c691f', '#d76c14', '#3c6123', '#356723', '#3e621f'],
['#3e841b', '#3d6a27', '#e7c9ee', '#3d6623', '#3e841b', '#376423', '#3a6825', '#3c6526'],
['#3a6320', '#396924', '#3e841b', '#38661e', '#3a6624', '#3a6b27', '#3d6421', '#3d6924'],
['#3a6424', '#d76c14', '#376927', '#396625', '#3a6629', '#c53312', '#3c6622', '#3d6820'],
['#3c671e', '#3e841b', '#3a6721', '#396721', '#e7c9ee', '#3e841b', '#3d6625', '#3b6126'],
['#376725', '#376829', '#406a21', '#406724', '#3e841b', '#36631f', '#386724', '#d76c14'],
['#386523', '#3a6421', '#3c6321', '#3a6825', '#3b6223', '#3e6523', '#3e691b', '#3e841b']],
...
"jade-cliffs": [['#456139', '#46633a', '#445c3a', '#4a5e3d', '#485e3f', '#433528', '#45583c', '#6d4e37'],
['#6d4e37', '#475a3f', '#465c3b', '#6d4e37', '#48593d', '#49593b', '#6d4e37', '#6d4e37'],
['#6d4e37', '#6d4e37', '#2a3e21', '#4a5e3b', '#465e38', '#445c3b', '#47603d', '#6d4e37'],
['#6d4e37', '#46613c', '#2a3e21', '#455e36', '#475e3c', '#6d4e37', '#4a5c39', '#4a613c'],
['#475c3c', '#2a3e21', '#2a3e21', '#2a3e21', '#475e41', '#2a3e21', '#6d4e37', '#4a6038'],
['#495f36', '#495f3b', '#433528', '#6d4e37', '#6d4e37', '#2a3e21', '#6d4e37', '#6d4e37'],
['#445f3d', '#446041', '#433528', '#4d5f3c', '#2a3e21', '#2a3e21', '#2a3e21', '#435b3a'],
['#455d3b', '#475c39', '#495b39', '#47603d', '#485a3b', '#433528', '#4b6133', '#4c5c3e']],
...
"rainforest": [['#085f2e', '#085f2e', '#0c7d3f', '#3256b3', '#3256b3', '#107944', '#0d7941', '#085f2e'],
['#4c3c25', '#0f7b44', '#3256b3', '#11823c', '#107a42', '#117a40', '#0a8040', '#137b3c'],
['#157c41', '#085f2e', '#085f2e', '#085f2e', '#0e7f3d', '#0c7d40', '#0f8142', '#117e43'],
['#0f7c3d', '#085f2e', '#085f2e', '#085f2e', '#0f7f41', '#0f8444', '#127d3e', '#3256b3'],
['#0f7d41', '#13803f', '#4c3c25', '#0e7f42', '#0f7f46', '#3256b3', '#3256b3', '#3256b3'],
['#3256b3', '#118040', '#0f803e', '#085f2e', '#085f2e', '#085f2e', '#3256b3', '#107a43'],
['#0c8042', '#0c8146', '#15833e', '#085f2e', '#085f2e', '#085f2e', '#0d8041', '#0b7c3f'],
['#085f2e', '#085f2e', '#117c3e', '#0f8142', '#4c3c25', '#137e40', '#138238', '#085f2e']],
...
"wetland": [['#325835', '#335a36', '#315336', '#375539', '#35553b', '#3c3f28', '#324f38', '#365833'],
['#325339', '#34513b', '#28b0e5', '#365833', '#355039', '#365037', '#1a311d', '#385133'],
['#325339', '#34513b', '#335337', '#375537', '#335534', '#1a311d', '#1a311d', '#1a311d'],
['#1a311d', '#1a311d', '#1a311d', '#325532', '#345538', '#1a311d', '#1a311d', '#1a311d'],
['#1a311d', '#1a311d', '#1a311d', '#335539', '#34553d', '#28b0e5', '#271e11', '#375734'],
['#365632', '#3c3f28', '#345635', '#335635', '#325539', '#375434', '#375539', '#35503a'],
['#28b0e5', '#31573d', '#3a5935', '#3a5638', '#1a311d', '#1a311d', '#1a311d', '#305236'],
['#325437', '#345335', '#365235', '#345739', '#1a311d', '#1a311d', '#1a311d', '#39533a']],
"woodland": [['#524128', '#5c6e2b', '#5a672b', '#60692e', '#5e6930', '#5e6330', '#5b632d', '#3a440e'],
['#5b672e', '#5d6530', '#5c672c', '#5f6c28', '#5e642e', '#5f642c', '#586a2c', '#616528'],
['#63662d', '#3a440e', '#3a440e', '#3a440e', '#5c6929', '#5a672c', '#5d6b2e', '#5f682f'],
['#5d6629', '#3a440e', '#3a440e', '#3a440e', '#5d692d', '#5d6e30', '#60672a', '#606c2d'],
['#5d672d', '#616a2b', '#524128', '#5c692e', '#5d6932', '#5e652d', '#5f692b', '#606b29'],
['#5f6a27', '#5f6a2c', '#5d6a2a', '#3a440e', '#3a440e', '#3a440e', '#60692e', '#5e642f'],
['#3a440e', '#3a440e', '#636d2a', '#3a440e', '#3a440e', '#3a440e', '#5b6a2d', '#59662b'],
['#3a440e', '#3a440e', '#5f662a', '#5d6b2e', '#524128', '#61682c', '#616c24', '#3a440e']]
			}
